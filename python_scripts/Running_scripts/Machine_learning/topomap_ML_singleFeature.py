...
filename = 'classifiers_epo_RT_before_allSpectral_100.csv'
...
for participant in participants:
    for classifier in classifiers:
        for feature in features:
            ...
            vmax = 0.75
            vmin = 0.5
            reportpath = '../../../OUTPUTS/ML_topomaps/ML_topomap_AllFeatures_{}_{}_{}.png'.format(participant, classifier, feature)
