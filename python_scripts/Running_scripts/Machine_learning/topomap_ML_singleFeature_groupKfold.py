...
filename = 'classifiers_epo_RT_StratGroupKfold_BAcc_minObs30_single_feature_k4_1vsMANY_LZ_100.csv'
...
for classifier in classifiers:
    for feature in features:
        ...
        vmax = 0.60
        vmin = 0.50
        reportpath = '../../../OUTPUTS/ML_topomaps/ML_topomap_AllFeatures_Stratroupkfold_RT_1vsMany_k4_{}_{}.png'.format(str(classifier), str(feature))
